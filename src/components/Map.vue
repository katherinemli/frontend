...
<div>
      ...
      <div v-if="drawerState" id="app">
        <div id="some-div">
          ...
          <q-drawer :width="338" v-model="drawerState" side="left" overlay behavior="desktop">
            ...
            <q-list v-show="!loandingConfig" separator>
              <q-item bordered
              v-show="!showRoute"
              v-for="point in addressSelected" :key="point.id" clickable v-ripple
        ...
        <div id="map-wrapper">
          <l-map style="height: 100%" ref="map" :zoom="zoom" :center="center" :options="mapOptions">
            ...
            <l-routing-machine
            v-if="showRoute"
            :data="addressSelected.map(a => a)" :waypoints="polyline.map(a => a)" />
          </l-map>
        </div>
      </div>
  ...
  <div class="map-wrapper-mobile">
            ...
            ref="map" :zoom="zoom" :center="center" :options="mapOptions">
            <l-tile-layer :url="url" :attribution="attribution" />
            <l-routing-machine
            v-if="showRoute"
            :data="addressSelected.map(a => a)" :waypoints="polyline.map(a => a)" />
     ...
     <q-page v-else class="spinner-container">
       <q-spinner-puff class="spinner-style" thickness="10" size="7em" color="black" />
     </q-page>
</div>
